...
2. **Tema Seçimi** 🌙
   - Header'daki tema butonuna (🌙/☀️) tıklayarak karanlık/aydınlık mod arasında geçiş yapın
...
Bu proje **Proprietary** lisans altında lisanslanmıştır.

**© 2024 emrahkartals - Tüm hakları saklıdır.**

Bu yazılım proprietary lisans altındadır. Kopyalama, değiştirme, dağıtım ve ticari kullanım yasaktır. İzinsiz kullanım yasal işlemlere tabi tutulabilir.

Detaylı lisans bilgileri için `LICENSE` dosyasına bakın.
